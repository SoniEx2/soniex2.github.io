...
var change_settings_form = document.createElement("form");
var difficulty_label = document.createElement("label");
difficulty_label.appendChild(document.createTextNode("Change difficulty: "));
var difficulty_box = document.createElement("input");
difficulty_box.type = "number";
difficulty_box.name = "difficulty";
difficulty_box.value = amount;
difficulty_label.appendChild(difficulty_box);
change_settings_form.appendChild(difficulty_label);
var timer_label = document.createElement("label");
timer_label.appendChild(document.createTextNode(" Disable timer: "));
var timer_box = document.createElement("input");
timer_box.type = "checkbox";
timer_box.name = "timer";
timer_box.value = "0";
timer_box.checked = !has_timer;
timer_label.appendChild(timer_box);
change_settings_form.appendChild(timer_label);
change_settings_form.appendChild(document.createTextNode(" "));
var change_settings_button = document.createElement("button");
change_settings_button.appendChild(document.createTextNode("Change settings"));
change_settings_form.appendChild(change_settings_button);
document.body.appendChild(change_settings_form);
